...
<div class="container">
  ...
  <div class="sidebar1">
    <ul class="nav">
      <li><a href="login_administrador.php">Ingreso Administrador</a></li>
      <li><a href="#">Ingreso Empleado</a></li>
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1 align="center">Ingreso para empleados.</h1>
    <?php
...
?>
<h2>Informacion</h2>
<p align="justify"><!-- end .content -->Esta sección del sistema es solo para el ingreso de usuarios  tipo empleado, en esta seccion puede consultar sus horas de llegada y salidas registradas como tambien puede justificar retrasos; si no es un usuario tipo empleado o no esta registrado en el sistema por favor comuniquese con el administrador. </p>
</div>
  <div class="footer">
